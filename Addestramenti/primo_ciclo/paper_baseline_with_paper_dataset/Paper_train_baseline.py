...
PARAMETERS_AND_NAME_MODEL = "la baseline del Paper"
...
train_data = pd.read_csv(
   '/mnt/sdc1/rmelillo/matty_dir/RSCD_dataset-1million/train.csv',
...
val_data = pd.read_csv(
   '/mnt/sdc1/rmelillo/matty_dir/RSCD_dataset-1million/val.csv',
    names=["image", "label","class"],dtype={'image':'str','label':'str','class':'str'})
...
TRAIN_PATH = "/mnt/sdc1/rmelillo/matty_dir/RSCD_dataset-1million/train"
VAL_PATH = "/mnt/sdc1/rmelillo/matty_dir/RSCD_dataset-1million/validation"
