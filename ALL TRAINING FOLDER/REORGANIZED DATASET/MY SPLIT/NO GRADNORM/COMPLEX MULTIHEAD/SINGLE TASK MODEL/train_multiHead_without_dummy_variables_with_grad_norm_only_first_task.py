...
PARAMETERS_AND_NAME_MODEL = "train_multiHead_without_dummy_variables_with_grad_norm_on_new_machine_corrected_only_first_task_new_split_corrected"
...
# #FINAL MODEL
model = MyClassifierModel(second_model.Backbone, ClassifierModel_1)
