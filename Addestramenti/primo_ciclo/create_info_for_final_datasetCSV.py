...
# Esempio di utilizzo:
#REORDERED DATASET
#/mnt/sdc1/rmelillo/matty_dir/dataset_reordered
#BASE DATASET
#/mnt/sdc1/rmelillo/matty_dir/RSCD_dataset-1million
cartella_base = "/mnt/sdc1/rmelillo/matty_dir/dataset_reordered"
class_dictionary = {
    "ice":0,
    "fresh_snow":1,
    "melted_snow":2,
...
nome_file = './train_reordered.csv'
scrivi_su_csv(info_set["train"], nome_file)
nome_file = './test_reordered.csv'
scrivi_su_csv(info_set["test"], nome_file)
nome_file = './val_reordered.csv'
