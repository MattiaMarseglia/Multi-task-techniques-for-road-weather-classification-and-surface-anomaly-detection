...
WEIGHT_FOR_COMPLEX_MODEL_1_INT_3_INTO_2 = '/user/mmarseglia/second_split_60_30_10/from_single_task_to_comlpex_multihead/train_multiHead_SI_dummy_vars_SI_grad_norm_cami_way_1_into_3_into_2_classifier_more_dropout_new_split.pt'

PARAMETERS_AND_NAME_MODEL = "train_multiHead_SI_dummy_vars_SI_grad_norm_cami_way_final_model_classifier_more_dropout_new_split"
...
checkpoint = load(WEIGHT_FOR_COMPLEX_MODEL_1_INT_3_INTO_2)
...
for param in model.Backbone2.features[8].parameters(): 
    param.requires_grad = True
for param in model.Classifier_1.parameters():
    param.requires_grad = True
for param in model.Backbone1.features[8].parameters(): 
    param.requires_grad = True
for param in model.Classifier_3.parameters():
    param.requires_grad = True
for param in model.Backbone3.features[8].parameters(): 
    param.requires_grad = True
    ...
    for epoch in range(num_epochs):
        ...
        for phase in ['train', 'val']:
            ...
            for sample_batched in tqdm(dataloaders[phase]):
                ...
                correctness = logical_and(logical_and((pred2 == labels2),(pred1 == labels1)), (pred3 == labels3)).long()
