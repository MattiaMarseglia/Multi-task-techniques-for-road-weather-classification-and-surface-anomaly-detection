...
from torch import device, set_grad_enabled, argmax, sum, save, is_tensor, logical_and, Tensor
from torchvision.models import efficientnet_b0, EfficientNet_B0_Weights
import debugpy

PARAMETERS_AND_NAME_MODEL = "train_multiHead_without_dummy_variables_with_grad_norm_new_split_more_droppout"
