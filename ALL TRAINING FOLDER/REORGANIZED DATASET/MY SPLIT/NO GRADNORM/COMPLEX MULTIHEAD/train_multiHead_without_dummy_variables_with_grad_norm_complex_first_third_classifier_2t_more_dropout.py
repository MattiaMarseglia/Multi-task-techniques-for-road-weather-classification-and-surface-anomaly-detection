...
WEIGHT_FOR_COMPLEX_MODEL_FIRST_TASK = '/user/mmarseglia/baseline_models/train_multiHead_SI_dummy_vars_SI_grad_norm_cami_way_1_classifier_more_dropout_new_split.pt'

PARAMETERS_AND_NAME_MODEL = "train_multiHead_SI_dummy_vars_SI_grad_norm_cami_way_1_into_3_classifier_more_dropout_new_split"
...
checkpoint = load(WEIGHT_FOR_COMPLEX_MODEL_FIRST_TASK)
...
for param in model.Backbone3.features[6].parameters(): 
    param.requires_grad = True
for param in model.Backbone3.features[7].parameters(): 
    param.requires_grad = True
