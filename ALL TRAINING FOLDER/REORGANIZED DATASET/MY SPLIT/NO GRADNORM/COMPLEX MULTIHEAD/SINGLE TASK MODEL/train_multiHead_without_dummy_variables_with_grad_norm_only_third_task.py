...
from torch import device, set_grad_enabled, argmax, sum, save, is_tensor, logical_and, load, Tensor
from torchvision.models import efficientnet_b0, EfficientNet_B0_Weights
import debugpy

WEIGHT_FOR_MODEL_SECOND_TASK = '/user/mmarseglia/baseline_models/train_multiHead_without_dummy_variables_with_grad_norm_on_new_machine_corrected_only_second_task_new_split_corrected.pt'

PARAMETERS_AND_NAME_MODEL = "train_multiHead_without_dummy_variables_with_grad_norm_on_new_machine_corrected_only_third_task_new_split_corrected"
...
# #FINAL MODEL
second_model = MyClassifierModel(backbone, ClassifierModel_2)

#load weigths for this model
checkpoint = load(WEIGHT_FOR_MODEL_SECOND_TASK)
second_model.load_state_dict(checkpoint)
...
# #FINAL MODEL
model = MyClassifierModel(second_model.Backbone, ClassifierModel_3)
    ...
    for epoch in range(num_epochs):
        ...
        for phase in ['train', 'val']:
            ...
            for sample_batched in tqdm(dataloaders[phase]):
                ...
                correctness = (pred3 == labels3).long()
