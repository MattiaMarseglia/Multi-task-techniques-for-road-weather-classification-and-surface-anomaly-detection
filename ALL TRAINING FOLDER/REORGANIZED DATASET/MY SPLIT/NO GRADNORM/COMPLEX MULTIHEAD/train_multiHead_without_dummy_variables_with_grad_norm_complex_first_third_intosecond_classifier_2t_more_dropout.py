...
WEIGHT_FOR_COMPLEX_MODEL_FIRST_TASK = '/user/mmarseglia/baseline_models/train_multiHead_SI_dummy_vars_SI_grad_norm_cami_way_1_into_3_classifier_more_dropout_new_split.pt'

PARAMETERS_AND_NAME_MODEL = "train_multiHead_SI_dummy_vars_SI_grad_norm_cami_way_1_into_3_into_2_classifier_more_dropout_new_split"
...
for param in model.Backbone2.features[6].parameters(): 
    param.requires_grad = True
for param in model.Backbone2.features[7].parameters(): 
    param.requires_grad = True
    ...
    for epoch in range(num_epochs):
        ...
        for phase in ['train', 'val']:
            ...
            for sample_batched in tqdm(dataloaders[phase]):
                ...
                correctness = (pred2 == labels2).long()
