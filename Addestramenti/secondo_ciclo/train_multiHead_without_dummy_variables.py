...
PARAMETERS_AND_NAME_MODEL = "train_multiHead_without_dummy_variables"
        ...
        for phase in ['train', 'val']:
            ...
            for sample_batched in tqdm(dataloaders[phase]):
                ...
                with set_grad_enabled(phase == 'train'):
                    ...
                    mask1 = (labels2 != 3 and labels2 != 4 and labels2 != 5 and labels3 != 2 and labels3 != 3)
                    mask3 = (labels2 != 3 and labels2 != 4 and labels2 != 5)

                    # Calculate loss for each sample using the masks
                    loss1 = criterion(out1[mask1], labels1[mask1])
                    loss2 = criterion(out2, labels2)
                    loss3 = criterion(out3[mask3], labels3[mask3])

                    print(len("out1: ", out1))
                    print(len("out3: ", out3))
                    print(len("out1[mask1]: ", out1[mask1]))
                    print(len("out3[mask3]: ", out3[mask3]))
