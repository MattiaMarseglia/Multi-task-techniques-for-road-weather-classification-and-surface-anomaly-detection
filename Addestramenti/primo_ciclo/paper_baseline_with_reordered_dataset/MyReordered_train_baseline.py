...
PARAMETERS_AND_NAME_MODEL = "My baseline, dataset reordered"
...
train_data = pd.read_csv(
   '/mnt/sdc1/rmelillo/matty_dir/dataset_reordered/train_reordered.csv',
...
val_data = pd.read_csv(
   '/mnt/sdc1/rmelillo/matty_dir/dataset_reordered/val_reordered.csv',
    names=["image", "label","class"],dtype={'image':'str','label':'str','class':'str'})
...
def train_model(model, base_criterion, optimizer, scheduler, early_stopper,num_epochs=25,best_loss=0.0, numTrain=1, acc_best_loss=0.0):
        ...
        for phase in ['train', 'val']:
            ...
            if phase == 'val':
                ...
                if early_stopper.early_stop(epoch_loss) == True:
                    ...
                    save(model.state_dict(), './My_baseline_dataset_reordered_models/'+ PARAMETERS_AND_NAME_MODEL+'.pt')
    ...
    with open('./My_baseline_dataset_reordered_evaluation_curves/'+PARAMETERS_AND_NAME_MODEL+ str(numTrain) +'training.json', 'w') as f:
