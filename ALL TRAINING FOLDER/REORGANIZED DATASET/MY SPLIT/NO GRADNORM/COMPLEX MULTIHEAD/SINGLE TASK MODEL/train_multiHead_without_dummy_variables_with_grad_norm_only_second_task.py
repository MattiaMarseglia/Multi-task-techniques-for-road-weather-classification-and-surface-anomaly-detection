...
PARAMETERS_AND_NAME_MODEL = "train_multiHead_without_dummy_variables_with_grad_norm_on_new_machine_corrected_only_second_task_new_split_corrected"
...
# #FINAL MODEL
model = MyClassifierModel(backbone, ClassifierModel_2)
