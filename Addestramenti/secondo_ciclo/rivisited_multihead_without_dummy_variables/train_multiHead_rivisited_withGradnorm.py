...
from torch import device, set_grad_enabled, argmax, sum, save, is_tensor, logical_and, unsqueeze
from torchvision.models import efficientnet_b0, EfficientNet_B0_Weights
import torch.functional as F

FINETUNING_BOOL = False

PARAMETERS_AND_NAME_MODEL = "train_MultiHead_Starter"
...
TRAIN_PATH = "/home/mattia/Desktop/Tesi/datasets/dataset_reordered/train"
VAL_PATH = "/home/mattia/Desktop/Tesi/datasets/dataset_reordered/validation"
...
train_set = DataLoader(trainDataSet,shuffle=True,batch_size=batch_size,num_workers=3, drop_last = True)
val_set = DataLoader(valnDataSet,shuffle=True, batch_size=batch_size,num_workers=3, drop_last = True)
...
model.eval()
# Observe that al palrameters are being optimized
