...
if __name__ == "__main__":
    ...
    csv_file_path = "/user/mmarseglia/second_split_60_30_10/train_dataset2_single_head copy.csv"
    replace_second_element_with_multi(csv_file_path, class_dictionary)
    csv_file_path = "/user/mmarseglia/second_split_60_30_10/validation_dataset2_single_head copy.csv"
    replace_second_element_with_multi(csv_file_path, class_dictionary)
    csv_file_path = "/user/mmarseglia/second_split_60_30_10/test_dataset2_single_head copy.csv"
    replace_second_element_with_multi(csv_file_path, class_dictionary)
