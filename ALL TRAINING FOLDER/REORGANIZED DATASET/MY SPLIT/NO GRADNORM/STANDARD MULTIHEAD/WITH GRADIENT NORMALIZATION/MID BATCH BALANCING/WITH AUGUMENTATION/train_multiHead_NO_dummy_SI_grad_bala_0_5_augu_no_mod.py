...
from torch import device, set_grad_enabled, argmax, sum, save, is_tensor, logical_and, Tensor, from_numpy
from torchvision.models import efficientnet_b0, EfficientNet_B0_Weights
# import debugpy
from torchvision.transforms import v2

PARAMETERS_AND_NAME_MODEL = "train_multiHead_without_dummy_variables_with_grad_norm_new_split_balanced_with_flatten_si_augumentation"
...
weights = harmonic_flattening(weights,0.6)
...
train_set = DataLoader(trainDataSet,sampler=sampler,batch_size=batch_size,num_workers=3)
...
model_ft,best_loss,train_losses,val_losses = train_model(model, criterion, optimizer, exp_lr_scheduler,
                       num_epochs=15,best_loss=best_loss,early_stopper=early_stopper,numTrain=1, class_dictionary=class_dictionary)