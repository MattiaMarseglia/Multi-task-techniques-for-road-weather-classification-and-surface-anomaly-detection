...
PARAMETERS_AND_NAME_MODEL = "train_multiHead_without_dummy_variables_REAL_grad_norm_in_batch_new_split_balanced_0"
...
weights = (1/count_values)
# weights = flattening(weights,0.3)
