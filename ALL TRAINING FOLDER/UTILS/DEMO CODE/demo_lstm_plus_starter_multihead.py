...
#test
#validation
WEIGHT_PATH = "/home/mattia/Desktop/Tesi/demo/models_weight/weight_lstm_model.tar"
...
# Interfaccia per l'elaborazione
...
# Combinare entrambe le interfacce in una singola pagina
gr.mix.Parallel(crop_interface, process_interface).launch()
